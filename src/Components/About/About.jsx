  ...
  return (
    <div className='about'>
      ...
      <div className="about-right">
        ...
        <p>Embark on a tranformative educational journey with out university's comprehensive education 
        ...
        <p>Whether you aspire to become a teacher, administrator, counselor, or education leader, our diverse
